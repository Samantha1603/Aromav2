...
//
//public class IngredientSearchUpload extends AppCompatActivity {
//
...
//                    Toast.makeText(IngredientSearchUpload.this, "Select at least one ingredient", Toast.LENGTH_LONG).show();
//                } else {
//                    Intent intent = new Intent(IngredientSearchUpload.this, DescriptionUpload.class);
...
//            public void onClick(View view) {
//
//                LayoutInflater inflater = IngredientSearchUpload.this.getLayoutInflater();
//                IngredientListDialog mBuilder = new IngredientListDialog(IngredientSearchUpload.this, ingredients, inflater);
//                mBuilder.show();
////                final AlertDialog.Builder mBuilder=new AlertDialog.Builder(IngredientsUploadActivity.this);
////                mBuilder.setTitle("Ingredients:");
////                mBuilder.setMessage("Enter search query here");
////                final EditText input=new EditText(IngredientsUploadActivity.this);
